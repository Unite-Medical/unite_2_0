...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (TERMS_METHODS.has(body.method) && body.action !== 'suspend' && live.session.email?.toLowerCase() !== 'damon@unitemedical.net') return sendJson(res,403,{error:'damon_credit_approval_required'});
