...
export async function receiveScans(lines, {
  ...
  if (typeof window !== 'undefined') {
    try {
      ...
      return { ok: false, mode: 'po', received: 0, events: 0, reason: body.reason || body.error || 'receive_failed' };
    } catch (error) {
      return { ok: false, mode: 'po', received: 0, events: 0, reason: 'receive_unreachable', detail: error.message };
    }
  }
