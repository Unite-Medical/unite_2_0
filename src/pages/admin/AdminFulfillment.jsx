    ...
    <AdminShell active="fulfillment">
      ...
      <div style={{ padding: isMobile ? 20 : 32 }}>
        ...
        <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap', marginBottom: 20 }}>
          {breakers.length === 0 && <div style={{ fontSize: 12, color: D.ink3 }}>No integration circuit failures recorded. Provider connectivity is not verified by this status.</div>}
          {breakers.map((b) => (
