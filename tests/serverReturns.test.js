...
test('refund cannot complete without matching provider evidence', () => {
  ...
  const fingerprint = refundFingerprint(pending);
  pending.refund_accuracy_review={fingerprint};
  pending.refund_final_approval={fingerprint,email:'damon@unitemedical.net'};
