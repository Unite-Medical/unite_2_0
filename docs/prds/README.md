...
| 25 | [Unite Native Inventory & Warehouse Management (UniteWMS)](PRD-25-native-wms.md) | #3 (replaces PRD-04 build path) | Owned movement-ledger WMS: lots/expiry, reservations/ATP, receiving, pick/pack/ship, counts, transfers |
| 26 | [Customer Order Management & Self-Service Ordering](PRD-26-customer-order-management.md) | founder directive | Per-customer pricing, pre-approved payment methods, auto-invoicing, quick/reorder, rep RBAC |
| 27 | [Distributor / 3PL Ordering, Consignment & Blind Shipping](PRD-27-distributor-consignment-3pl.md) | founder directive | Owner-segregated consignment inventory, scan in/out, blind ship, custom packing slips, PO ingestion, third-party billing + rate markup |
