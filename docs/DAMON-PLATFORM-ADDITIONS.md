...
- **Buy side:** Unite markets that inventory to willing buyers, INCLUDING non-traditional channels for items hospitals can't use: **non-medical buyers for expired items, veterinary, research use, overseas clients, etc.** (broadens who a lot can go to).
